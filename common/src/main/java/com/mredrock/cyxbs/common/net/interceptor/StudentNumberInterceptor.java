package com.mredrock.cyxbs.common.net.interceptor;
 ...
 * Intercepted API:
 * {@link com.mredrock.cyxbs.common.config.Const#API_SOCIAL_HOT_LIST}
 * {@link com.mredrock.cyxbs.common.config.Const#API_SOCIAL_BBDD_LIST}
 * {@link com.mredrock.cyxbs.common.config.Const#API_GET_PERSON_LATEST}
...
public class StudentNumberInterceptor implements Interceptor {
    ...
    private Response doIntercept(Chain chain) throws IOException {
        ...
        if (originalFormBody instanceof FormBody) {
            ...
            newBuilder.add("idNum", DataBus.getUser().idNum);
            newBuilder.add("stuNum", DataBus.getUser().stuNum);
